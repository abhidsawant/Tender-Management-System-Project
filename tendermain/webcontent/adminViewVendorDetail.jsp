<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@ page import="java.sql.*, com.hit.utility.DBUtil,com.hit.dao.VendorDao,com.hit.dao.VendorDao" errorPage="errorpage.jsp"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">ndorDaoImpl,com.hit.beans.VendorBean, javax.servlet.annotation.WebServlet
<html lang="en">
  <head>
